...
<div <?php echo fw_attr_to_html( $wrapper_attr ) ?>>
	...
	<div class="fw-table">
		...
		<div class="fw-table-row fw-table-cols-delete">
			<div class="fw-table-cell fw-table-cell-options">
				<a href="#" class="fw-table-add-row button button-large"><?php echo esc_html__( 'Add Row', 'olam' ) ?></a>
			</div>
			<?php for ( $j = 0; $j <= $last_col; $j ++ )  : ?>
		...
		<input type="hidden" class="fw-table-last-row" value="<?php echo esc_attr($last_row); ?>"/>
		<input type="hidden" class="fw-table-last-col" value="<?php echo esc_attr($last_col); ?>"/>
	</div>
</div>