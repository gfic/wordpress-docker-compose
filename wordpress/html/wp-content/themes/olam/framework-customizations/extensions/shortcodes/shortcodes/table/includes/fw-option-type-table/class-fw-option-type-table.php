...
class FW_Option_Type_Table extends FW_Option_Type
{
	...
	protected function _render( $id, $option, $data ) {
		...
		if ( ! $table_shortcode ) {
			trigger_error(
				esc_html__( 'table-builder option type must be inside the table shortcode', 'olam' ),
				E_USER_ERROR
				);
		}
	...
	protected function _get_defaults() {
		return array(
			'header_options'  => array(
				'table_purpose' => array(
					'type'    => 'select',
					'label'   => esc_html__( 'Table Styling', 'olam' ),
					'desc'    => esc_html__( 'Choose the table styling options', 'olam' ),
					'choices' => array(
						'pricing' => esc_html__( 'Use the table as a pricing table', 'olam' ),
						'tabular' => esc_html__( 'Use the table to display tabular data', 'olam' ),
						),
					'value'   => 'pricing',
					'attr'    => array(
			...
			'row_options'     => array(
				'name' => array(
					...
					'desc'    => false,
					'choices' => array(
						'default-row' => esc_html__( 'Default row', 'olam' ),
						'heading-row' => esc_html__( 'Heading row', 'olam' ),
						'pricing-row' => esc_html__( 'Pricing row', 'olam' ),
						'button-row'  => esc_html__( 'Button row', 'olam' ),
						'switch-row'  => esc_html__( 'Row switch', 'olam' )
						),
					)
				),
			'columns_options' => array(
				'name' => array(
					...
					'desc'    => false,
					'choices' => array(
						'default-col'   => esc_html__( 'Default column', 'olam' ),
						'desc-col'      => esc_html__( 'Description column', 'olam' ),
						'highlight-col' => esc_html__( 'Highlight column', 'olam' ),
						'center-col'    => esc_html__( 'Center text column', 'olam' )
						),
					)
				),
			'content_options' => array(
				...
				'pricing-row' => array(
					'currency'      => array(
						...
						'value'        => '',
						'attr' => array(
							'placeholder' => esc_html__('currency', 'olam')
							),
						'wrapper_attr' => array(
							'class' => 'fw-col-sm-4'
							)
					...
					'description' => array(
						...
						'value'        => '',
						'attr' => array(
							'placeholder' => esc_html__('per month', 'olam')
							),
						'wrapper_attr' => array(
							'class' => 'fw-col-sm-4'
							)
				...
				'button-row'  => array(
					...
					? array(
						'type'          => 'popup',
						'popup-title'   => esc_html__( 'Button', 'olam' ),
						'button'        => esc_html__( 'Add', 'olam' ),
