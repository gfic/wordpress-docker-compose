...
$of_options = array();
$of_options[] = array( 
	"name" 		=> esc_html__("General Settings","olam"),
	"type" 		=> "heading"
	);
$of_options[] = array( 
	...
	'std'       => 'https://themes.layero.com/olamwp2/wp-content/uploads/2016/03/logo2-1.png',
	"type" 		=> 'upload'
	);
$of_options[] = array( 
	...
	'std'       => 'https://themes.layero.com/olamwp2/wp-content/uploads/2016/03/retina-2.png',
	"type" 		=>  "upload"
	);
$of_options[] = array( 
	...
	'std'	    => 'https://themes.layero.com/olamwp2/wp-content/uploads/2016/03/fav-1.png',
	"type" 		=> "upload");
$of_options[] = array( 
...
$of_options[] = array( 
	...
	"type" 		=> "color");
$of_options[] = array( 
	"name" 		=> esc_html__("Header text color","olam"),
	"desc" 		=> esc_html__("Please Select color for header/menu text.","olam"),
	"id" 		=> $prefix."_header_txt_color",
	"std" 		=> "#ffffff",
	"type" 		=> "color");
...
$of_options[] = array( 
	...
	"desc" 		=> esc_html__("Select styling for EDD Download item boxes. Style 1 - Item box moves upwards on hover with box shadow style / Style 2 - Item thumbnail zooms on hover with box without border / Style 3 - Item thumbnail zooms on with and box with border","olam"),
...
$of_options[] = array( 
	...
	'std'		=> 'https://themes.layero.com/olamwp/wp-content/uploads/2016/02/olam-banner-inner.jpg',
	"type" 		=> "upload");
$of_options[] = array(
...
$of_options[] = array(
	...
	"desc" 		=> esc_html__("Check to enable Preloader for the theme","olam"),
...
$of_options[] = array(
	"name" 		=> esc_html__("Hide icons in download listings","olam"),
	"desc" 		=> esc_html__("Check this to hide the download, view and add to cart icons in the product listing box","olam"),
	"id" 		=> $prefix."_hide_details",
	'std'       => 0,
	"type" 		=> "checkbox",
	);
$of_options[] = array(
	"name" 		=> esc_html__("Display categories instead of By:Author name","olam"),
	"desc" 		=> esc_html__("Check this to display category name of the download instead of the author name in listing pages","olam"),
	"id" 		=> $prefix."_show_cats",
	'std'       => 0,
	"type" 		=> "checkbox",
	);
$of_options[] = array( 	
	"name" 		=> esc_html__("Custom Product Count","olam"),
	"desc" 		=> esc_html__("Enter the number of products to be displayed in a page","olam"),
	"id" 		=> "olam_product_count",
	"type" 		=> "text",
	);
$of_options[] = array(
...
$of_options[] = array( 	
	"name" 		=> esc_html__("Pinterest URL","olam"),
	"desc" 		=> esc_html__("Pinterest URL","olam"),
...
$of_options[] = array( 	
	...
	"desc" 		=> esc_html__("Some servers require the contact form send function to have a specific From Email Address. Add your contact email here in case you are having trouble getting contact form emails.","olam"),
...
$of_options[] = array( 	
	"name" 		=> esc_html__("Quick contact support title text","olam"),
	"desc" 		=> esc_html__("Customize the text for Quick Support window title","olam"),
	"id" 		=> $prefix."_footer_support_title",
	"std"		=> "Support",
	"type" 		=> "text"
	);

$of_options[] = array( 	
	"name" 		=> esc_html__("Disable quick contact (support) window","olam"),
	"desc" 		=> esc_html__("Disable quick contact (support) window","olam"),
...
// Backup Options
$of_options[] = array( 	
	"name" 		=> esc_html__("Backup Options","olam"),
	"type" 		=> "heading",
	"icon"		=> ADMIN_IMAGES . "icon-backup.png"
	);

$of_options[] = array( 	
	"name" 		=> esc_html__("Backup and Restore Options","olam"),
	"id" 		=> "of_backup",
	"std" 		=> "",
	"type" 		=> "backup",
	"desc" 		=> esc_html__('You can use the two buttons below to backup your current options, and then restore it back at a later time. This is useful if you want to experiment on the options but would like to keep the old settings in case you need it back.',"olam"),
	);

$of_options[] = array( 	
	"name" 		=> esc_html__("Transfer Theme Options Data","olam"),
	"id" 		=> "of_transfer",
	"std" 		=> "",
	"type" 		=> "transfer",
	"desc" 		=> esc_html__('You can tranfer the saved options data between different installs by copying the text inside the text box. To import data from another install, replace the data in the text box with the one from another install and click "Import Options".',"olam"),
	);
