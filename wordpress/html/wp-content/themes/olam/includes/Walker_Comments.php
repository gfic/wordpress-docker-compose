<?php  
class Olam_Walker_Comment extends Walker_Comment
{ 
				...
				<div id="comment-body-<?php comment_ID() ?>" class="comment-section">
					...
					<div class="comment-bg">
						<div class="comment_details">
							<div class="commenter_name"><?php echo get_comment_author_link(); ?></div>
							<span><?php comment_date(); ?></span>
						</div>
						<div id="comment-content-<?php comment_ID(); ?>" class="comment_message">
							<?php if( !$comment->comment_approved ) : ?>
							<em class="comment-awaiting-moderation"><?php esc_html_e("Your comment is awaiting moderation.","olam");?></em>					
