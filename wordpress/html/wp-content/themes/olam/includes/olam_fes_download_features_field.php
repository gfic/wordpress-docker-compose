<?php
class Olam_FES_Download_Features_Field extends FES_Field {
...
die('aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa');
	...
	public function set_title() {
		$title = _x( 'Olam download features', 'FES Field title translation', 'edd_fes' );
