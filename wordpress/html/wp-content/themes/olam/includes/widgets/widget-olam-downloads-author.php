...
class olam_downloads_author_widget extends WP_Widget {
...

	{
		...
		<div class="user-info">
			...
			$avatarCustom=get_the_author_meta('authorbanner', $author);
			...
			if( isset($avatarUrl) && (strlen($avatarUrl)>0) ) { ?><div class="author-pic"><a href="<?php echo esc_url($authorPostsUrl); ?>"><img src="<?php echo esc_url($avatarUrl) ?>" alt="<?php the_author(); ?>"></a></div><?php } else { ?><div class="author-pic"><a href="<?php echo esc_url($authorPostsUrl); ?>"><img src="<?php echo esc_url(get_template_directory_uri()); ?>/img/avatar.jpg" alt="<?php the_author(); ?>"></a></div><?php } ?>
			...
			<ul class="user-badges">
				...
				<?php
				$featImage=null;
				$realfeatImage = wp_get_attachment_image_src( get_post_thumbnail_id( $postsvalue->ID ), 'olam-product-thumb-small' );
				...
				?>
				<li><a href="<?php echo get_permalink($postsvalue); ?>">
					<?php if(isset($featImage)){ ?>
						<img src="<?php echo esc_url($featImage); ?>" alt="<?php echo get_the_title($postsvalue); ?>">
					<?php } elseif (isset($realfeatImage)){ ?>
						<img src="<?php echo esc_url($realfeatImage); ?>" alt="<?php echo get_the_title($postsvalue); ?>">
							<?php } else { ?>
						<img src="<?php echo esc_url(get_template_directory_uri()); ?>/img/thumbnail.png" alt="<?php echo get_the_title($postsvalue); ?>">
					<?php } ?></a></li>
				<?php } ?>
