			...
			<td class="edd_cart_item_name">
				...
				//if ( current_theme_supports( 'post-thumbnails' ) && has_post_thumbnail( $item['id'] ) ) {
					...
					<?php if((isset($featImage))&&(strlen($featImage)>0)){
						...
						?><span class="edd_cart_item_image_thumb"><img src="<?php echo esc_url($featImage); ?>" alt="<?php echo esc_attr($item_title); ?>"></span><?php
					} 
					elseif (isset($realfeatImage)){ ?>
						<span class="edd_cart_item_image_thumb">
							<img src="<?php echo esc_url($realfeatImage); ?>" alt="<?php echo esc_attr($item_title); ?>">
						</span>
					...
					<?php } else { ?>
						<span class="edd_cart_item_image_thumb"><img src="<?php echo esc_url(get_template_directory_uri()); ?>/img/product-thumb-small.jpg" alt="<?php echo esc_attr($item_title); ?>"></span>
					<?php	}
