...
if ( $purchases ) :
	...
	<table id="edd_user_history">
		<thead>
			<tr class="edd_download_history_row">
				...
				<th class="edd_download_download_name"><?php esc_html_e( 'Download Name', 'olam' ); ?></th>
				<?php if ( ! edd_no_redownload() ) : ?>
					<th class="edd_download_download_files"><?php esc_html_e( 'Files', 'olam' ); ?></th>
							...
							<td class="edd_download_download_files">
								...
								if ( edd_is_payment_complete( $payment->ID ) ) :
									if ( $download_files ) :
										...
										esc_html_e( 'No downloadable files found.', 'olam' );
									endif; // End if payment complete
								else : ?>
									<span class="edd_download_payment_status">
										<?php printf( esc_html__( 'Payment status is %s', 'olam' ), edd_get_payment_status( $payment, true) ); ?>
									</span>
									<?php
	...
	<p class="edd-no-downloads"><?php esc_html_e( 'You have not purchased any downloads', 'olam' ); ?></p>
	<?php
endif;
