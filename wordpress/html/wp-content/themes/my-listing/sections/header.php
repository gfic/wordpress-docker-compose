	...
	<div class="header-container">
		<div class="header-top container-fluid">
			...
			<div class="header-right">
				...
				<?php if ( $data['show_search_form'] && ( $explore_link = c27()->get_setting('general_explore_listings_page') ) ): ?>
					<div class="search-trigger">
						<a href="<?php echo esc_url( add_query_arg( 'mt', 'f', $explore_link ) ) ?>"><i class="material-icons">search</i></a>
					</div>
				<?php endif ?>
			</div>
		</div>
