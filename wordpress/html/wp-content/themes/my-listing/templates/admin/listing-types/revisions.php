...
<div class="current-actions">
	...
	<a href="<?php echo esc_url( $import_url ) ?>" class="button" id="mylisting_import_start" data-confirm="<?php echo esc_attr( $import_message ) ?>"><?php _ex( 'Import config file', 'Listing type editor', 'my-listing' ) ?></a>
	<input type="file" id="mylisting_import_config" style="display: none;">
</div>
