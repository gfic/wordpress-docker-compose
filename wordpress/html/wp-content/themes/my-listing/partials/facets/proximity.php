...
$lat = esc_attr( "facets['{$data['listing_type']}'].search_location_lat" );
$lng = esc_attr( "facets['{$data['listing_type']}'].search_location_lng" );
$address = esc_attr( "facets['{$data['listing_type']}'].search_location" );
?>
