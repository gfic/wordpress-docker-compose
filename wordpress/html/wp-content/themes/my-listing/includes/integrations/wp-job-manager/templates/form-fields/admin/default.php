 ...
 */
if ( $_field_template = locate_template( 'includes/integrations/wp-job-manager/templates/form-fields/admin/'.$type.'.php' ) ) {
	$field_template = $_field_template;
} elseif ( $_field_template = locate_template( 'includes/integrations/wp-job-manager/templates/form-fields/'.$type.'-field.php' ) ) {
	$field_template = $_field_template;
} elseif ( $_field_template = locate_job_manager_template( 'form-fields/'.$type.'-field.php') ) {
	$field_template = $_field_template;
} else {
	return;
}
...
$field_template = locate_template( 'includes/integrations/wp-job-manager/templates/form-fields/admin/'.$type.'.php' )
	?: locate_template( 'includes/integrations/wp-job-manager/templates/form-fields/'.$type.'-field.php' );
?>
