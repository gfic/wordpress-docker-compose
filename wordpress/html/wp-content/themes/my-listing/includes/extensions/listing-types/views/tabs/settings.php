			...
			<div class="column">
				<div class="card">
					...
					<div class="form-group">
						...
						<input type="text" :value="settings.permalink" @input="settings.permalink = sanitize_title( $event.target.value )" placeholder="<?php echo esc_attr( $type->get_permalink_name() ) ?>">
					</div>
				</div>
